...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='created_time',
            field=models.DateTimeField(default=datetime.datetime(2019, 9, 18, 8, 42, 26, 330464, tzinfo=utc), verbose_name='创建日期'),
        ),
        migrations.AlterField(
            model_name='post',
            name='excerpt',
        ...
        migrations.AlterField(
            model_name='post',
            name='modified_time',
            field=models.DateTimeField(default=datetime.datetime(2019, 9, 18, 8, 42, 26, 330500, tzinfo=utc), verbose_name='修改日期'),
        ),
        migrations.AlterField(
            model_name='post',
            name='tags',
